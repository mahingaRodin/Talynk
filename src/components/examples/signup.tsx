...
const SignupPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (password !== confirmPassword) {
      signup.error = new Error("Passwords do not match");
      return;
    }

    if (!agreeToTerms) {
      signup.error = new Error("You must agree to the terms and conditions");
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center">
          <input
            ...
            required
          />
          <label htmlFor="agree-terms" className="ml-2 text-sm text-slate-700">
            I agree to the{" "}
            <a
              href="/terms"
        ...
        <button
          ...
          disabled={signup.isPending || redirecting}
        >
          {signup.isPending ? (
